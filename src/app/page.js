        ...
        <main className={styles.main}>
            <div className={styles.container}>
                ...
                <ContainerOption
                    title={"conta"}
                    rows={[
                        { image: personalData, description: "Dados pessoais" },
                        {
                ...
                <ContainerOption
                    title={"preferências"}
                    rows={[
                        { image: notifications, description: "Notificações" },
                        { image: accessibility, description: "Acessibilidade" },
                    ]}
                />
                <ContainerOption
                    title={"privacidade"}
                ...
                <ContainerOption
                    rows={[
                        { image: help, description: "Central de ajuda" },
                        { image: exit, description: "Sair" },
                    ]}
                />
            </div>
        </main>
